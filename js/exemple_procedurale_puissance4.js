...
// Insert your JQuery code for the game
    ...
    $("td").click(function() {
        ...
        if (player_turn === 1) {  // player 1 turn
            ...
            $(this).children().attr('src', 'img/red-coin.gif'); // on affiche visuellement sur la grille de jeu le jeton correspondant au player 1
            ...
            $(this).children().attr('src', 'img/yello-coin.gif'); // on affiche visuellement sur la grille de jeu le jeton correspondant au player 2
